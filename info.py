heroes_names = ["Abaddon","Alchemist","Ancient Apparition","Anti-Mage","Axe",
	...
	"Earthshaker","Earth Spirit","Elder Titan","Ember Spirit","Enchantress","Enigma",
	"Faceless Void",
	"Gyrocopter",
	"Huskar",
	"Invoker","Io",
	...
	"Queen of Pain",
	"Razor","Riki","Rubick",
	"Sand King","Shadow Demon","Shadow Fiend","Shadow Shaman","Silencer","Skywrath Mage","Slardar","Slark","Sniper","Spectre","Spirit Breaker","Storm Spirit","Sven",
...
# heroes_names1 = ["Abaddon","Alchemist","Ancient Apparition","Anti-Mage"]
# heroes_names3 = ["Abaddon", "Ancient Apparition", "Anti-Mage", "Nature's Prophet"]
# heroes_names = ["Abaddon"]